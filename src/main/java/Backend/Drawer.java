...
public class Drawer {
    ...
    private Drawer()
    {
        ...
        String vertShaderSrc = "#version 430 core\n" +
                ...
                "\n" +
                "    //Rotate\n" +
                "    mpos.x = (pos.x * cos(ObjectBuffer.objects[objectId].rotation) - pos.y * sin(ObjectBuffer.objects[objectId].rotation));\n" +
                "    mpos.y = (pos.y * cos(ObjectBuffer.objects[objectId].rotation) + pos.x * sin(ObjectBuffer.objects[objectId].rotation));\n" +
                "\n" +
                "    //Scale\n" +
